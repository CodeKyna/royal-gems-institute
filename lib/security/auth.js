...
exports.validateFileSize = exports.generateSecureFilename = exports.validateFileType = exports.createRateLimitKey = exports.escapeHtml = exports.sanitizeInput = exports.verifyCSRFToken = exports.generateCSRFToken = exports.verify2FAToken = exports.generateQRCode = exports.generate2FASecret = exports.generatePasswordResetToken = exports.verifyToken = exports.generateTokens = exports.validatePasswordStrength = exports.verifyPassword = exports.hashPassword = void 0;
...
var generateTokens = function (payload) {
    var accessToken = jsonwebtoken_1.default.sign(payload, JWT_SECRET, { expiresIn: '15m' });
    var refreshToken = jsonwebtoken_1.default.sign(payload, JWT_REFRESH_SECRET, { expiresIn: '7d' });
    return { accessToken: accessToken, refreshToken: refreshToken };
};
exports.generateTokens = generateTokens;
var verifyToken = function (token, isRefreshToken) {
    if (isRefreshToken === void 0) { isRefreshToken = false; }
    try {
...
var generateQRCode = function (otpauthUrl) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
