...
export default function SettingsPage() {
  ...
  async function loadData() {
    ...
    setPermissions([
      { name: 'user_management', description: 'Create, update, delete users', roles: ['SuperAdmin', 'Admin'] },
      { name: 'product_management', description: 'Manage gem listings and approvals', roles: ['SuperAdmin', 'Admin', 'Moderator'] },
      { name: 'order_management', description: 'View and manage orders', roles: ['SuperAdmin', 'Admin'] },
      { name: 'audit_logs', description: 'View audit logs', roles: ['SuperAdmin', 'Admin'] },
      { name: 'system_settings', description: 'Configure system settings', roles: ['SuperAdmin'] },
      { name: 'financial_reports', description: 'Access financial reports', roles: ['SuperAdmin', 'Admin'] }
    ]);
